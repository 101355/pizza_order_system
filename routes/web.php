...
Route::prefix('category')->group(function(){
    ...
    Route::prefix('user')->group(function(){
        ...
        Route::get('editAccount/{id}',[UserController::class,'userAccountEdit'])->name('admin#userAccountEdit');
        Route::post('updateAccount/{id}',[UserController::class,'userAccountUpdate'])->name('admin#userAccountUpdate');
        Route::get('deleteAccount/{id}',[UserController::class,'userAccountDelete'])->name('admin#userAccountDelete');  
        Route::get('contactList',[UserController::class,'contactList'])->name('admin#contactList');      
        Route::get('contactMessage/{id}',[UserController::class,'contactMessage'])->name('admin#contactMessage');
        Route::get('contactDelete/{id}',[UserController::class,'contactDelete'])->name('admin#contactDelete');
    });
    ...
    Route::group(['prefix'=>'user','middleware'=>'user_auth'],function(){
        ...
        Route::prefix('contact')->group(function(){
            ...
            Route::post('contactCreate',[ContactController::class,'contactCreate'])->name('contact#contactCreate');
        });
    });
});
