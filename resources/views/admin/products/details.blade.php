                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <div class="my-3 btn bg-danger text-white d-block w-50 text-center fs-5">
                                        {{ $pizza->name }}</div>
                                    <span class="my-3 btn bg-dark text-white "><i
                                            class="fa-solid fs-4 fa-money-bill me-2"></i>{{ $pizza->price }} kyats
                                    </span>
                                    <span class="my-3 btn bg-dark text-white "><i
                                            class="fa-regular fs-4 fa-clock me-2"></i>{{ $pizza->waiting_time }} mins
                                    </span>
                                    <span class="my-3 btn bg-dark text-white "><i
                                    ...
                                    <span class="my-3 btn bg-dark text-white"><i
                                            class="fa-solid fs-4 fa-user-clock me-2"></i>{{ $pizza->created_at->format('j-F-Y') }}
                                    </span>
