                                    ...
                                    <div class="row col-6">
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" disabled name="name"
                                                type="text"value="{{ old('name', $account->name) }}" class="form-control"
                                                aria-required="true" aria-invalid="false" placeholder="Enter Admin Name">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label mb-1">Role</label>
                                            <select name="role" class="form-control">
                                                <option value="admin" @if ($account->rolen == 'admin') selected @endif>
                                                    Admin</option>
                                                <option value="user" @if ($account->rolen == 'user') selected @endif>
                                                    User</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" disabled name="email"
                                                type="email"value="{{ old('email', $account->email) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" disabled name="phone"
                                                type="number"value="{{ old('phone', $account->phone) }}"
                                                class="form-control" aria-required="true" aria-invalid="false"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" disabled id="" cols="30" rows="10"
                                                class="form-control "placeholder="Enter Admin Address">{{ old('address', $account->address) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
