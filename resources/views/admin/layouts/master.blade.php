                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('admin#contactList') }}">
                                <i class="fa-solid fa-address-card"></i>Contact List
                            </a>
                        </li>
                    </ul>
                </nav>
                                        ...
                                        <div class="image">
                                            @if (Auth::user()->image == null)
                                                @if (Auth::user()->gender == 'male')
                                                    <img
                                                        src="{{ asset('image/male-profile-picture.webp') }}"class="img-thumbnail">
                                                @else
                                                    <img
                                                        src="{{ asset('image/female-profile-picture.webp') }}"class="img-thumbnail">
                                                @endif
                                            @else
