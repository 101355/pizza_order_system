                ...
                <div class="col-lg-10 offset-1">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin#userAccountUpdate', $account->id) }}" method="POST"
                                ...
                                <div class="row ">
                                    ...
                                    <div class="row col-6">
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="name"
                                                type="text"value="{{ old('name', $account->name) }}"
                                    ...
                                    @enderror"placeholder="Enter Admin Address">{{ old('address', $account->address) }}</textarea>
                                            @error('address')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="cc-pament" name="role"
                                                type="text"value="{{ old('role', $account->role) }}"
